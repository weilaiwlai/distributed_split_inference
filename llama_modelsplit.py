...
class LlamaModel_Client(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig, client_layers: int, max_context_len: int):
    ...
    def forward(
        ...
        for i, decoder_layer in enumerate(self.layers):
            ...
            if i == 40: 
                ...
                position_embeddings = tuple(pe.to('cuda:2') if hasattr(pe, 'to') else pe for pe in position_embeddings)
            if i == 60: 
