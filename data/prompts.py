...
"""  # noqa: E501
    ...
    elif dataset == Dataset.GSM8K:
        question = example["question"].strip("\n")
        prompt = f"""[INST]Your task is to solve the following math word problem step by step.
Provide a clear, detailed solution and the final answer.
Problem: {question}
[/INST]"""  # noqa: E501
