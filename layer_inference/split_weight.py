...
# ==========================================================================================
# 根据你的模型结构，修改下面的字典。
# Key 是逻辑部分的名称，Value 是在 safetensors 文件中实际的权重名称前缀。
# 通常你只需要从你的 AirLLM 主类中复制 set_layer_names_dict 的内容即可。
MODEL_CONFIG = {
...
def preprocess_and_split_weights(model_path: str, config: dict):
    ...
    output_dir = Path("/home/yueshuaibing/models/Qwen3-32B/layers_safetensors")
...
if __name__ == '__main__':
    # ------------------ 使用前请修改此路径 ------------------
    MODEL_PATH = "/opt/models/Qwen3-32B"# <--- 修改这里
    # ---------------------------------------------------------
